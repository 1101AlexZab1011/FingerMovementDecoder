...
for i in {0..10}
    do 
        ./venv/bin/python ./LFCNN_separated.py -cms "B1 B2 B3" "B10 B11 B12" -cmc "LI" "LM" "RI" "RM" --no-params
    done
...
for i in {0..10}
    do 
        ./venv/bin/python ./LFCNN_separated.py -cms "B1 B2 B3" "B10 B11 B12" -cmc "LI" "LM" --no-params
    done

# right
for i in {0..10}
    do 
        ./venv/bin/python ./LFCNN_separated.py -cms "B1 B2 B3" "B10 B11 B12" -cmc "RI" "RM" --no-params
    done
